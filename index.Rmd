...
2. Due to this bundling, I use it as a comprehensive CV for my work in (experimental) linguistics that links to the various items; see the `Research` and `Teaching` tabs.
